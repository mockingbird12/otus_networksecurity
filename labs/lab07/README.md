...
## Анализ дампа
В данном файле мы видим взаимодействие по vlana'м по стандарту 802.1Q.
IP-адреса:
 192.168.10.1
 192.168.20.1
 192.168.30.1
...
В трафике мы видим много взаимодействия по протоколу STP. Можно сделать вывод что это дамп трафика из какой-то сети с маршрутизаторами/коммутаторами Cisco(в мак-адресе присутсвует Cisco)

* 192.168.10.1 (00:1e:7a:79:3f:11) - интерфейс Cisco
* 192.168.20.1 (00:1e:7a:79:3f:11) - интерфейс Cisco
* 192.168.30.1 (00:1e:7a:79:3f:11) - интерфейс Cisco с DHCP сервером возможно?
* 192.168.30.11 (00:21:70:e9:bb:47) - ноутбук Dell
* 192.168.110.10 (00:14:69:9e:11:41) - Другое устройство Cisco с TFTP-сервером, на который скидывают конфиг устройства.
* 192.168.121.10 (00:21:1b:ae:31:c1) - устройство Cisco ?Маршрутизатор?
* 192.168.120.10 (00:00:0c:9f:f0:79) - устройство Cisco, syslog-сервер.
* 192.168.121.40 (00:16:47:df:e7:c1) - устройство Cisco, используется для ntp-запросов
